...
export const timelineData: mainTimeline[] = [
  ...
  },
  {
    ...
    desc: [
      ...
      },
      {
        title: "DICE GAME",
        description:
          "Designed and implemented an interactive dice game application that simulates the rolling of dice with realistic animations and sound effects. Incorporated random number generation for authentic gameplay, along with score tracking and game statistics. The user interface was developed with a focus on simplicity and user engagement, featuring customizable dice themes and game settings for an enhanced user experience.",
      },
    ],
  },
  {
  ...
  {
    title: "Compunell(JP. Morgan Chase) | React Developer | Jan 2024- Present",
    desc: [
      {
        title: "FullStack Development",
        description:
          "Steered front-end projects using React, Redux, Tailwind, and Webpack, showcasing expertise and Employ knowledge of backend technologies and Amazon Web Services to support full-stack development initiatives.",
      },
      {
        title: "Technical Documentation",
        description:
          "Created RTM, functional/technical specifications, and documented complex processes using flowcharts and diagrams.",
      },
      {
        title: "Solution Design & POCs",
        description:
          "Designed and presented solution architectures; developed Proof of Concepts (POCs) to validate design efficiency and decision-making.",
      },
      {
        title: "Application Development",
        description:
          "Built advanced web and mobile applications using ReactJS, Redux, ensuring state management and cross-browser compatibility. Worked with Octagon and bluejs frameworks to build robust Single-door and Wrapper applications.",
      },
      {
        title: "Tech Stack Expertise",
        description:
          "Delivered robust software leveraging JavaScript, TypeScript, HTML5, CSS, and jQuery.",
      },
      {
        title: "Performance & Maintenance",
        description:
          "Improved application performance through optimization, debugging, and revisions, adhering to security best practices for sustainability.",
      },
      {
        title: "Agile Development",
        description:
          "Followed Agile/Waterfall methodologies to design, develop, and integrate systems and software modules across multiple teams.",
      },
      {
        title: "Testing",
        description:
          "Developed and executed unit test cases for React components using React Testing Library, ensuring high code coverage and reliability. Implemented UDF test cases utilizing Cucumber for Behavior-Driven Development (BDD). Enhanced application performance and user experience through testing and optimization techniques.",
      },
    ],
  },
];
